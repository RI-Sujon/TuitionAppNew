package com.example.tuitionappv2.tuition_post;
...
public class TuitionPostViewActivity extends AppCompatActivity {
    ...
    private String userEmail ,tutorUid;
...
//        getSupportActionBar().hide();
    ...
    public void viewTuitionPost(){
        adapter  = new CustomAdapterForTuitionPostView(this,tuitionPostInfoArrayList, userEmail,tutorUid) ;
